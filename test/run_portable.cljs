...
(require '[cljs.test :as t]
         '[kotoba.car-sim-test]
         '[kotoba.car-sim.color-test]
         '[kotoba.car-sim.controls-test]
         '[kotoba.car-sim.garage-test]
         '[kotoba.car-sim.ground-test]
         '[kotoba.car-sim.scene-test])

(defmethod t/report [:cljs.test/default :end-run-tests] [m]
  (when-not (t/successful? m) (set! (.-exitCode js/process) 1)))

(t/run-tests 'kotoba.car-sim-test
              'kotoba.car-sim.color-test
              'kotoba.car-sim.controls-test
              'kotoba.car-sim.garage-test
              'kotoba.car-sim.ground-test
